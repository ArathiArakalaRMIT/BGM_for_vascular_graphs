...
getGraph_PV<-function(wdname,sourceid,person,LR,Session,Nr){
  ...
  inputNodesFile<-paste(wdname,"/P_o",personid,"_",LR,"_S",Session,"_Nr",Nr,"_bpoints.txt",sep="")
  inputEdgesFile<-paste(wdname,"/P_o",personid,"_",LR,"_S",Session,"_Nr",Nr,"_links.txt", sep="")
